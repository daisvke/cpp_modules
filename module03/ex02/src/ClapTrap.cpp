...
/*   Updated: 2022/07/05 19:22:44 by dtanigaw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(ClapTrap const &obj, const std::string name)
	: _name(name), _hitPoints(obj._hitPoints),
...
void	ClapTrap::takeDamage( unsigned int amount )
{
	if (_hitPoints > 0)
	{
		...
		std::cout << _name << " is attacked causing "
...
void	ClapTrap::beRepaired( unsigned int amount )
{
	...
	{
		_hitPoints += amount;
		std::cout << _name << " is repaired causing "
